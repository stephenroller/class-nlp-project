...
We find that, for one of our two test sets, the use of search engine results returned from Bing outperforms no use of search engine results.
Our model performs significantly worse on the second test set---search engine results were actually detrimental. 
...
One difference explaining this is that the 1.7 test set contains a significantly higher percentage of items with supersense {\tt noun.person}: 62.60\%, vs 26.11\% in the 1.6 test set.
