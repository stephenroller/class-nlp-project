...
We did not expect to perform as well as \cite{curran} on the task, as our model has significantly fewer features, uses a smaller data set, and has no backoff model. 
