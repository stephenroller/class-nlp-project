...
Figure \ref{fig:damping} gives the performance of the algorithm with different damping coefficient $\gamma$, as described in bullet point \ref{item:voting} of Section \ref{sec:alg}.
