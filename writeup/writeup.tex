...
Because so many of the test words are proper names of well-known individuals and, when these names are mentioned on the internet, they are typically in relation to some set of things for which these individuals are well-known, using the web here ends up harming performance.
...
(STEPHEN: IS THIS CLAIM SUPPORTED BY THE EVIDENCE?)
